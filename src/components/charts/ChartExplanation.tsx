...
export const CHART_METADATA: Record<string, { title: string; description: string; icon: string }> = {
  netWorth: {
    ...
    description: 'This shows your total net worth (all your money and assets) over time. The blue line is if you buy, the green line is if you rent. Higher = more money.',
    icon: '💰'
  },
  monthlyCost: {
    title: 'What will I pay each month?',
    description: 'This breaks down your monthly costs. Buying includes mortgage, property tax, insurance, and maintenance. Renting includes rent and renter\'s insurance.',
    icon: '📅'
  },
  breakEven: {
    title: 'When does buying become worth it?',
    description: 'This shows the month when buying catches up to renting financially. If the break-even point is after your timeline, renting is better.',
    icon: '⏰'
  },
  totalCost: {
    title: 'Total cost comparison',
    description: 'This compares everything you\'ll spend over your timeline. It includes the final value of your home or investments.',
    icon: '💵'
  },
  equity: {
    title: 'How much house will I own?',
    description: 'This shows your equity - the part of the home you actually own versus what you still owe on the mortgage.',
    icon: '🏠'
  },
  monteCarlo: {
    title: 'What if the market changes?',
    description: 'This shows 1,000 possible outcomes for home prices based on market volatility. The shaded area shows the range of likely scenarios.',
    icon: '🎲'
  },
  sensitivity: {
    title: 'How sensitive is this to rate changes?',
    description: 'This shows how your net worth changes if appreciation rates or mortgage rates are different than expected.',
    icon: '📊'
  },
  taxSavings: {
  ...
  cashFlow: {
    ...
    description: 'This shows the difference in monthly costs. Positive means renting costs more (buying saves money), negative means buying costs more.',
    icon: '💸'
  },
  cumulativeCost: {
